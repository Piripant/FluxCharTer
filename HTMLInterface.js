...
(function() {
  var DisableAll, DrawNexts, DrawSelections, HTML_SetAttributes, HTML_els, HideAllEl, ShowAllEl, clickAction, isMouseDown, loadClick, moveName, newClick, selNoName, selYesName, selectName;
  ...
  this.NewDia = function() {
    return swal({
      title: "Warning!",
      text: "If you haven't saved all data will be lost",
  ...
  this.SaveDia = function() {
    ...
    return swal({
      ...
      html: "<span>(double click + CTRL+C to copy)</span><br><br><textarea rows=20 cols=50 readonly=true style=\"resize:none\">" + text + "</textarea>"
    });
  };
