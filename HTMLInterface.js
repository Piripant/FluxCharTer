...
(function() {
  var DisableAll, DrawNexts, DrawSelections, HTML_SetAttributes, HTML_els, HideAllEl, ShowAllEl, clickAction, lastID, loadClick, moveName, selNoName, selYesName, selectName;
  ...
  this.SaveDia = function() {
    ...
    return swal({
      ...
      text: "<textarea rows=20 cols=50 readonly=true style=\"resize:none\">" + text + "</textarea>",
      html: true
    });
  };
  ...
  this.LoadDia = function() {
    return swal({
      title: "Input save file (double click to copy)",
      type: "input",
